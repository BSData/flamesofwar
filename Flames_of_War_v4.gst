...
<gameSystem id="976a-b687-1fdb-07ef" name="Flames of War v4" revision="25" battleScribeVersion="2.03" authorName="Ulf Bernestedt" authorContact="battlescribe@bernestedt.se" xmlns="http://www.battlescribe.net/schema/gameSystemSchema" type="gameSystem">
...
updated info in v20 by mdcooledge</comment>
    ...
    <publication name="Late-War Leviathans" id="9fff-fd82-e3c2-d110" hidden="false" publicationDate="2024" publisherUrl="www.flamesofwar.com"/>
  </publications>
  <costTypes>
